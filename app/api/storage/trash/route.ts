...
const SECTION_SOURCES: SectionSource[] = [
  ...
  { key: 'blog', label: 'Blog Posts', table: 'blog_posts', columns: ['hero_image_path', 'card_image_path'] },
  { key: 'home-bestsellers', label: 'Home Best Sellers', table: 'cms_home_bestseller_products', columns: ['display_image_path'] },
