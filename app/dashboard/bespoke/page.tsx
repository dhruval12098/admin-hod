...
async function getBespokePageData(): Promise<BespokePageData> {
  ...
  const [submissionsResult, heroSectionResult, heroItemsResult, categoriesResult, itemsResult, processItemsResult, formSettingsResult, guaranteesResult, pieceTypesResult, stoneOptionsResult, caratOptionsResult, metalOptionsResult] = await Promise.all([
