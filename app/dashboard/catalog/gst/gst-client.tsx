...
export function GstClient({ initialItems }: { initialItems: CatalogGstSlab[] }) {
  const [items, setItems] = useState<CatalogGstSlab[]>(initialItems)
  ...
  return (
    <div className="p-8">
      ...
      {loading ? (
        <div className="mt-8 text-sm text-muted-foreground">Updating GST slabs...</div>
      ) : null}
