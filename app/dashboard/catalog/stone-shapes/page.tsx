  ...
  return (
    <div className="p-8">
        ...
        <DialogContent className="max-h-[85vh] overflow-y-auto sm:max-w-2xl">
          ...
          <div className="space-y-5">
              ...
              <div className="flex gap-3">
                <button type="button" onClick={() => setSaveConfirmOpen(true)} className="rounded-lg bg-primary px-4 py-2 text-sm font-semibold text-white hover:bg-primary/90">
                  Save
                </button>
                <button type="button" onClick={() => setIsFormOpen(false)} className="rounded-lg border border-border px-4 py-2 text-sm font-semibold text-foreground hover:bg-secondary">
                  Cancel
                </button>
              </div>
            </div>
      ...
      <ConfirmDialog
        ...
        confirmText="Delete"
        type="delete"
        onConfirm={() => deleteTarget && void deleteShape(deleteTarget.id)}
