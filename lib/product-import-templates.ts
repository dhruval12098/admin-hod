...
export const PRODUCT_IMPORT_COLUMNS: ProductImportColumn[] = [
  ...
  },
  {
    ...
    group: 'optional',
    required: false,
    description: 'Optional product video public URL, or a filename when supplied inside the ZIP archive.',
    example: 'https://cdn.example.com/products/HDR-1001_video.mp4',
  },
  {
    key: 'spec_1_key',
...
export function buildProductImportImageGuide() {
  return [
    ...
    '3. Match the exact file names in the CSV image columns.',
    '4. Video can be either a public URL or a ZIP filename.',
    '5. Do not paste storage paths into the image columns.',
    '',
    ...
    '- HDR-1001_detail.jpg',
    '- HDR-1001_video.mp4',
    '- https://cdn.example.com/products/HDR-1001_video.mp4',
    '',
    'Tips:',
    ...
    '- If your product video already lives in Cloudflare R2 or another CDN, paste its full public URL into the video column.',
