...
function mapWideRowToImportRow(row: WideSheetRow, tabName: GoogleSheetSyncTab): ParsedProductImportRow {
  ...
  return {
    ...
    spec_4_key: '',
    spec_4_value: '',
    faq_1_question: firstNonEmpty(row, ['faq_1_question', 'FAQ 1 Question']),
    faq_1_answer: firstNonEmpty(row, ['faq_1_answer', 'FAQ 1 Answer']),
    faq_2_question: firstNonEmpty(row, ['faq_2_question', 'FAQ 2 Question']),
    faq_2_answer: firstNonEmpty(row, ['faq_2_answer', 'FAQ 2 Answer']),
    faq_3_question: firstNonEmpty(row, ['faq_3_question', 'FAQ 3 Question']),
    faq_3_answer: firstNonEmpty(row, ['faq_3_answer', 'FAQ 3 Answer']),
    faq_4_question: firstNonEmpty(row, ['faq_4_question', 'FAQ 4 Question']),
    faq_4_answer: firstNonEmpty(row, ['faq_4_answer', 'FAQ 4 Answer']),
    faq_5_question: firstNonEmpty(row, ['faq_5_question', 'FAQ 5 Question']),
    faq_5_answer: firstNonEmpty(row, ['faq_5_answer', 'FAQ 5 Answer']),
    engraving_label: '',
